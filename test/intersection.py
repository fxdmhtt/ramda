...
class Test_intersection(unittest.TestCase):
    ...
    #     eq(self, R.intersection([0], [-0]).length, 0)
    #     eq(self, R.intersection([-0], [0]).length, 0)
    #     eq(self, R.intersection([NaN], [NaN]).length, 1)
    #     eq(self, R.intersection([Just([42])], [Just([42])]).length, 1)
